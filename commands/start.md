...
You're about to build something against the real Sui DeepBook sandbox, hand-driving the JSON-RPC layer and decoding the on-chain order book yourself. No indexer shortcuts; pure chain reads. The first lesson, *Market Stats — Chain-Direct*, ships a 24-test gate that says you got it right.
