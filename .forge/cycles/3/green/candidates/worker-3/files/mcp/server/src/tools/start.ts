...
import type { OutputStyleWarning } from '../outputStyle.js';
...
// StartResult warnings accept OutputStyleWarning, RegistryWarning, and StateWarning.
// Using the wire-compatible superset to maintain backward compat while satisfying T-173.
export type AnyWarning = OutputStyleWarning | RegistryWarning | StateWarning;
  ...
  switch (stateResult.kind) {
    ...
    case 'corrupt': {
      ...
      if (stateResult.archivedTo !== undefined) {
        warning.archivedTo = stateResult.archivedTo;
      }
