...
export function validateState(v: unknown): ValidationResult<StateData> {
  ...
  if (typeof obj['personalization'] !== 'object' || obj['personalization'] === null || Array.isArray(obj['personalization'])) {
  ...
  if (typeof obj['ladder'] !== 'object' || obj['ladder'] === null || Array.isArray(obj['ladder'])) {
    return { ok: false, error: 'ladder must be an object (not an array)' };
  }
