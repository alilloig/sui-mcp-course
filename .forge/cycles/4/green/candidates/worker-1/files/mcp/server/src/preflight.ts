 ...
 * Per-call spawn injection: probes receive opts.spawn directly (no global
 * mutable seam). A13 carry-forward: setSpawnOverride and spawnOverrides Map
 * are removed; harness fixtures pass stubs through ProbeOptions.spawn at the
 * call site.
 */
