...
export function validatePath(v: unknown): ValidationResult<PathData> {
  ...
  let personalizationRanges: PersonalizationRanges | undefined;
  if (obj['personalization_ranges'] !== undefined) {
    if (typeof obj['personalization_ranges'] !== 'object' || obj['personalization_ranges'] === null) {
      return { ok: false, error: 'personalization_ranges must be an object if present' };
    }
    const ranges = obj['personalization_ranges'] as Record<string, unknown>;
    personalizationRanges = {};

    if (ranges['poll_interval_ms'] !== undefined) {
      if (typeof ranges['poll_interval_ms'] !== 'object' || ranges['poll_interval_ms'] === null) {
        return { ok: false, error: 'personalization_ranges.poll_interval_ms must be an object' };
      }
      const pim = ranges['poll_interval_ms'] as Record<string, unknown>;
      ...
      personalizationRanges.poll_interval_ms = {
    ...
    if (ranges['pool_subset'] !== undefined) {
      if (typeof ranges['pool_subset'] !== 'object' || ranges['pool_subset'] === null) {
        return { ok: false, error: 'personalization_ranges.pool_subset must be an object' };
      }
      const ps = ranges['pool_subset'] as Record<string, unknown>;
      if (!Array.isArray(ps['values']) || typeof ps['default'] !== 'string') {
        return { ok: false, error: 'personalization_ranges.pool_subset requires values array and default string' };
      }
      personalizationRanges.pool_subset = {
  ...
  return {
    ...
    value: {
      ...
      ...(personalizationRanges !== undefined ? { personalization_ranges: personalizationRanges } : {}),
    },
  };
}
