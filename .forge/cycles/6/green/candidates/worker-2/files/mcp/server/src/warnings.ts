...
// Cycle 6: added output-style-plugin-not-enabled warning (H002/AC-1.1).
...
// Cycle 6: output-style-plugin-not-enabled (H002/AC-1.1)
// Emitted when the enabledPlugins key is missing/non-object or the plugin
// key is absent / not === true. Replaces the former bare { ok: false } return.
