...
// Cycle 6: added output-style-plugin-not-enabled (H002 fix — replaces bare { ok: false } branches).
...
// Cycle 6 H002: named warning for the plugin-not-enabled paths in outputStyle.ts.
// Replaces the two bare { ok: false } branches that returned no warning.
