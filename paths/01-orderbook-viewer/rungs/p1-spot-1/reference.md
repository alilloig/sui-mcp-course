# Reference — Lines 39–58 of App.tsx

The following is the reference implementation for the three SDK configuration helpers (lines 39–58 of `src/App.tsx`):
...
These functions extract the `packageIds`, `coinMap`, and `poolMap` structures from the sandbox deployment manifest and feed them into the `deepbook(...)` SDK extension.
